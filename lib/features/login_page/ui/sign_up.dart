                      ...
                      child: SingleChildScrollView(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color:
                                      const Color.fromARGB(255, 109, 223, 211),
                                  width: 1),
                                ...
                                child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    //   ),
                                      ...
                                      //     blurRadius: 1.0,
                                      //     spreadRadius: 2.0,
                                      //     color: const Color.fromARGB(255, 79, 196, 147)!.withOpacity(0.3),
                                      //   ),
                                      // ],
                                    ),
                                  ),
          ...
          children: [
            SizedBox(
              ...
              child: Theme(
                ...
                child: RadioListTile(
                  contentPadding: EdgeInsets.zero,
                  activeColor: const Color.fromARGB(227, 76, 198, 217),
                  title: Text(
                    'FE',
                    style: AppStyles.NormalText().copyWith(
                      color: const Color.fromARGB(227, 76, 198, 217),
                      fontSize: 25,
                    ),
                  ),
                  value: 1,
