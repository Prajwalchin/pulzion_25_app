...
import '/features/event_description/ui/event_description.dart';
import '../../../../constants/models/event_model.dart';

class DarkSample extends StatefulWidget {
  final Events event;
  const DarkSample(
      {required this.event, super.key, required this.resumeTimeFunction});
...
class _DarkSampleState extends State<DarkSample> {
  ...
  void initState() {
    super.initState();
    t1 = Timer(const Duration(milliseconds: 80), () {
      setState(() {
        isDark = !isDark;
      });
    });
    t2 = Timer(const Duration(milliseconds: 500), () {
      setState(() {
        isDark = !isDark;
      });
    });
...
ThemeData _darkTheme = ThemeData(
  ...
  primaryColor: const Color.fromARGB(255, 22, 113, 136),
  scaffoldBackgroundColor:
      const Color.fromARGB(255, 8, 53, 53).withOpacity(0.2),
